...
#running bandpass filters is a useful tool for manual investigation on features
#changing between time graphs and frequency graphs for visualization helps with the feature selection process
#in machine learning problems that are related to signal processing
